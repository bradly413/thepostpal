...
.pb-dash {
  ...
  background:#f1f1f3; color:var(--ink); font-family:var(--sans); font-size:14px; line-height:1.4;
...
.pb-dash .logo { font-weight:800; font-size:20px; letter-spacing:-.02em; margin-bottom:32px; text-decoration:none; color:var(--ink); display:inline-block; width:fit-content; cursor:pointer; transition:opacity .15s; }
...
.pb-dash .profile .name { font-weight:600; font-size:14px; }
.pb-dash .profile .role { color:var(--muted); font-size:13px; margin-top:1px; }
.pb-dash .profile .chev { color:var(--muted-2); flex-shrink:0; }
.pb-dash .create-btn { width:100%; background:var(--red); color:#fff; padding:13px 16px; border-radius:10px; font-weight:600; font-size:14px; display:flex; align-items:center; justify-content:center; gap:8px; margin-bottom:16px; transition:background .15s; white-space:nowrap; }
.pb-dash .create-btn:hover { background:#d61f2c; }
.pb-dash .nav { display:flex; flex-direction:column; gap:2px; }
.pb-dash .nav a { display:flex; align-items:center; gap:12px; padding:11px 12px; border-radius:10px; color:var(--ink-2); font-size:14px; font-weight:500; transition:background .15s; white-space:nowrap; }
...
.pb-dash .upgrade .label { font-size:13px; color:var(--muted); }
.pb-dash .upgrade .pro { font-weight:700; color:var(--red); font-size:15px; margin:2px 0 6px; }
.pb-dash .upgrade .copy { font-size:12px; color:var(--muted); line-height:1.45; margin-bottom:12px; }
.pb-dash .upgrade a { width:100%; background:#fff; border:1px solid var(--line-2); border-radius:8px; padding:9px; font-size:13px; font-weight:500; text-align:center; display:block; }
...
.pb-dash .sidebar-foot .mini-avatar { width:30px; height:30px; border-radius:50%; background:#e8e8ec; color:var(--ink-2); font-size:11px; font-weight:600; display:grid; place-items:center; flex-shrink:0; }
.pb-dash .sidebar-foot .name { font-size:13px; font-weight:500; flex:1; }
...
.pb-dash .pill { display:inline-flex; align-items:center; gap:6px; background:#fff; border:1px solid var(--line-2); border-radius:999px; padding:5px 12px; font-size:12px; font-weight:500; width:fit-content; }
...
.pb-dash .tag { display:inline-flex; align-items:center; background:#fff; border:1px solid var(--line-2); border-radius:8px; padding:6px 12px; font-size:11px; font-weight:600; letter-spacing:.08em; text-transform:uppercase; color:var(--ink-2); margin-top:14px; width:fit-content; }
.pb-dash .hero h1 { font-family:var(--serif); font-weight:500; font-size:clamp(38px,4.2vw,56px); line-height:1.02; letter-spacing:-.02em; margin-top:20px; }
.pb-dash .hero p.sub { color:var(--muted); margin-top:14px; font-size:14.5px; line-height:1.5; max-width:360px; }
.pb-dash .hero-actions { display:flex; gap:10px; margin-top:28px; flex-wrap:wrap; }
.pb-dash .btn-primary { background:var(--red); color:#fff; padding:13px 22px; border-radius:10px; font-weight:600; font-size:14px; display:inline-flex; align-items:center; gap:8px; transition:background .15s; white-space:nowrap; }
.pb-dash .btn-primary:hover { background:#d61f2c; }
.pb-dash .btn-secondary { background:#fff; border:1px solid var(--line-2); color:var(--ink); padding:13px 22px; border-radius:10px; font-weight:500; font-size:14px; display:inline-flex; align-items:center; gap:8px; white-space:nowrap; }
...
.pb-dash .feature-week .ftag { color:var(--red); font-size:10.5px; font-weight:700; letter-spacing:.1em; text-transform:uppercase; margin-bottom:8px; }
.pb-dash .feature-week .ftitle { font-family:var(--serif); font-size:18px; font-weight:500; line-height:1.2; }
.pb-dash .feature-week .fsub { font-size:12.5px; color:var(--muted); margin-top:8px; }
...
.pb-dash .card-head .label { font-weight:600; font-size:14px; }
...
.pb-dash .post .title { font-size:13.5px; font-weight:500; margin-bottom:3px; }
.pb-dash .post .date { font-size:12px; color:var(--muted); }
.pb-dash .post .live-tag { display:flex; align-items:center; gap:5px; font-size:12px; color:var(--muted); flex-shrink:0; }
.pb-dash .post .live-tag .d { width:6px; height:6px; background:var(--green); border-radius:50%; }
.pb-dash .view-all, .pb-dash .voice-edit { margin-top:16px; padding-top:16px; border-top:1px solid var(--line); display:flex; align-items:center; justify-content:space-between; font-size:13px; font-weight:500; width:100%; }
.pb-dash .view-all svg, .pb-dash .voice-edit svg { color:var(--muted); }
.pb-dash .voice-quote { font-family:var(--serif); font-weight:500; font-size:28px; line-height:1.12; letter-spacing:-.015em; margin-bottom:18px; }
.pb-dash .voice-sub { font-size:13.5px; color:var(--muted); line-height:1.5; flex:1; }
.pb-dash .studio-head { display:flex; align-items:center; gap:10px; margin-bottom:18px; }
.pb-dash .studio-head .p-badge { width:30px; height:30px; background:var(--red); color:#fff; border-radius:8px; display:grid; place-items:center; font-weight:700; font-family:var(--serif); font-size:17px; flex-shrink:0; }
.pb-dash .studio-head .ai-tag { background:var(--red-soft); color:var(--red); font-size:11px; font-weight:600; letter-spacing:.06em; padding:4px 10px; border-radius:999px; text-transform:uppercase; }
.pb-dash .studio-title { font-family:var(--serif); font-weight:500; font-size:26px; line-height:1.1; letter-spacing:-.015em; margin-bottom:12px; }
.pb-dash .studio-sub { font-size:13.5px; color:var(--muted); line-height:1.5; margin-bottom:16px; }
...
.pb-dash .nextup .date-badge .m { background:var(--red); color:#fff; font-size:9px; font-weight:700; letter-spacing:.1em; padding:2px 0; }
.pb-dash .nextup .date-badge .d { font-size:17px; font-weight:700; padding:3px 0 4px; }
.pb-dash .nextup h3 { font-size:15px; font-weight:600; margin-bottom:4px; }
.pb-dash .nextup .sched { font-size:12.5px; color:var(--muted); margin-bottom:14px; }
.pb-dash .nextup .view-schedule { width:100%; background:#fff; border:1px solid var(--line-2); border-radius:10px; padding:11px; font-size:13.5px; font-weight:500; text-align:center; display:block; }
...
.pb-dash .week-saved .label { font-size:13px; color:var(--muted); margin-bottom:6px; }
...
.pb-dash .week-saved .subtitle { font-size:12.5px; color:var(--muted); margin-top:8px; }
...
.pb-dash .overview h4 { font-size:15px; font-weight:600; margin-bottom:2px; }
.pb-dash .overview .range { font-size:12.5px; color:var(--muted); margin-bottom:18px; }
...
.pb-dash .bar { width:100%; max-width:14px; background:#e7e7eb; border-radius:4px; transition:opacity .2s; }
.pb-dash .bar.active { background:var(--red); }
.pb-dash .chart-labels { display:grid; grid-template-columns:repeat(7,1fr); gap:8px; font-size:11.5px; color:var(--muted); text-align:center; margin-bottom:18px; }
.pb-dash .stats { display:grid; grid-template-columns:1fr 1fr; gap:12px; margin-bottom:16px; }
.pb-dash .stat .skey { font-size:12.5px; color:var(--muted); margin-bottom:4px; }
...
.pb-dash .view-analytics { width:100%; background:#fff; border:1px solid var(--line-2); border-radius:10px; padding:11px; font-size:13.5px; font-weight:500; display:flex; align-items:center; justify-content:space-between; }
...
@media (max-width:600px){
  ...
  .pb-dash .voice-quote { font-size:26px; }
}
